...
const en = {
  ...
  serviceModal: {
    ...
    applicationDesc: 'Deploy web applications, APIs or microservices from Docker images or Git repositories',
    database: 'Database',
    databaseDesc: 'PostgreSQL, MySQL, MongoDB or Redis with automatic configuration',
    dockerImage: 'Docker Image',
    dockerImageDesc: 'Use a pre-built Docker image from DockerHub or a registry',
    gitRepository: 'Git Repository',
    gitRepositoryDesc: 'Build and deploy from your GitHub, GitLab or Bitbucket repository',
    back: 'Back',
    next: 'Next',
    cancel: 'Cancel',
    ...
    nameInvalid: 'Name can only contain lowercase letters, numbers and hyphens',
    nameExists: 'A service with this name already exists',
    dockerImageRequired: 'Docker image is required',
    repositoryRequired: 'Repository URL is required',
    portRequired: 'Internal port is required',
