...
const pt_BR = {
  ...
  dashboard: {
    ...
    monitoringCardsView: 'Visualização dos Cards',
    ...
    emptyStateAction: 'Criar Primeiro Projeto',
    emptyStateHelp: 'Precisa de ajuda?',
    emptyStateDocs: 'Ver Documentação',
    // Quick Actions
    quickActions: 'Ações Rápidas',
    quickActionCreateProject: 'Criar Projeto',
    quickActionCreateService: 'Criar Serviço',
    quickActionViewDocs: 'Documentação',
    quickActionViewMetrics: 'Métricas do Sistema',
    // Getting Started
    gettingStarted: 'Primeiros Passos',
    gettingStartedDescription: 'Complete estas etapas para começar',
    gettingStartedCreateProject: 'Criar seu primeiro projeto',
    gettingStartedDeployService: 'Implantar um serviço',
    gettingStartedConfigureDomain: 'Configurar domínio personalizado',
    gettingStartedInviteTeam: 'Convidar membros da equipe',
    ...
    systemMetricsDescription: 'Monitoramento em tempo real do seu host',
  ...
  // Settings (já definido acima nas linhas 178-228, removendo duplicação)
  ...
  serviceModal: {
    createNewService: 'Criar Novo Serviço',
    stepXofY: 'Passo {step:number} de {total:number}',
    chooseType: 'Escolher Tipo',
    configure: 'Configurar',
    reviewCreate: 'Revisar e Criar',
    application: 'Aplicação',
    applicationDesc: 'Implante aplicações web, APIs ou microsserviços a partir de imagens Docker ou repositórios Git',
    database: 'Banco de Dados',
    databaseDesc: 'PostgreSQL, MySQL, MongoDB ou Redis com configuração automática',
    dockerImage: 'Imagem Docker',
    dockerImageDesc: 'Use uma imagem Docker pré-construída do DockerHub ou um registro',
    gitRepository: 'Repositório Git',
    gitRepositoryDesc: 'Construa e implante a partir do seu repositório GitHub, GitLab ou Bitbucket',
    back: 'Voltar',
    next: 'Próximo',
    cancel: 'Cancelar',
    ...
    created: 'Criado!',
    serviceName: 'Nome do Serviço',
    serviceNamePlaceholder: 'meu-servico',
    serviceNameHint: 'Apenas letras minúsculas, números e hífens',
    dockerImageLabel: 'Imagem Docker',
    dockerImagePlaceholder: 'nginx:latest',
    internalPort: 'Porta Interna',
    internalPortPlaceholder: '3000',
    exposedPort: 'Porta Exposta (Opcional)',
    exposedPortPlaceholder: '8080',
    ...
    selectDatabaseType: 'Selecionar Tipo de Banco de Dados',
    ...
    nameInvalid: 'O nome pode conter apenas letras minúsculas, números e hífens',
    nameExists: 'Já existe um serviço com este nome',
    dockerImageRequired: 'Imagem Docker é obrigatória',
    repositoryRequired: 'URL do repositório é obrigatória',
    portRequired: 'Porta interna é obrigatória',
    serviceCreatedSuccess: 'Serviço criado com sucesso!',
    createError: 'Falha ao criar serviço',
    postgres: 'PostgreSQL',
    mysql: 'MySQL',
    mongodb: 'MongoDB',
    redis: 'Redis',
