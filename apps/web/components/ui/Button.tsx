...
export const Button: React.FC<ButtonProps> = ({
  ...
  const baseStyles = 'font-medium rounded-lg transition-all shadow-sm hover:shadow-md focus:outline-none focus:ring-4 disabled:opacity-50 disabled:cursor-not-allowed flex items-center justify-center gap-2';
  ...
  const variantStyles = {
    ...
    outline: 'border-2 border-primary text-primary bg-white hover:bg-primary hover:text-white active:bg-primaryHover active:border-primaryHover focus:ring-primary/20',
  };
