...
**Responsável**: `.github/agents/openpanel-orchestrator.md`
...
**Responsável**: `.github/agents/openpanel-backend-specialist.md`
...
**Responsável**: `.github/agents/openpanel-frontend-specialist.md`
...
**Responsável**: `.github/agents/openpanel-qa-specialist.md`
...
**Responsável**: `.github/agents/openpanel-devops-infra-specialist.md`
...
**Responsável**: `.github/agents/openpanel-security-compliance-auditor.md`
...
**Responsável**: `.github/agents/openpanel-docs-ux-maintainer.md`
...
**Responsável**: `.github/agents/openpanel-database-architect.md`
...
Todos os agentes estão em `.github/agents/` e respondem **exclusivamente em português brasileiro**:
