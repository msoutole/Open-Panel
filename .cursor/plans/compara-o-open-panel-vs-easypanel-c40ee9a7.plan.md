<!-- c40ee9a7-36b0-4502-b71d-93c5889bb746 27a52d0b-9104-49f7-ba8b-2fc17b9fb0fd -->
...
- [ ] Criar sistema base de templates de aplicações com suporte a YAML/JSON e carregamento dinâmico
- [ ] Implementar template-loader.ts para carregar e validar templates de arquivos YAML
- [ ] Criar template-engine.ts para processar variáveis, dependências e deploy de templates
- [ ] Criar rotas /api/templates para listar, buscar e deployar templates
- [ ] Criar UI completa (TemplateSelector, TemplateMarketplace) no frontend
- [ ] Implementar 20 templates iniciais mais populares (WordPress, Ghost, Node.js, Python, etc)
- [ ] Implementar backend de 2FA (TOTP, QR codes, backup codes) em two-factor.ts
- [ ] Adicionar campos 2FA ao schema Prisma (twoFactorEnabled, twoFactorSecret, backupCodes)
- [ ] Criar rotas /auth/2fa/enable, /auth/2fa/verify, /auth/2fa/disable
- [ ] Criar UI de configuração e login com 2FA (TwoFactorSetup.tsx)
- [ ] Implementar estratégia blue-green deployment no build.ts
- [ ] Implementar health checks avançados antes de trocar tráfego
- [ ] Integrar blue-green com Traefik para gradual traffic shifting
- [ ] Implementar rollback automático em caso de falha no health check
- [ ] Criar endpoints para execução de queries SQL (PostgreSQL, MySQL, MongoDB, Redis)
- [ ] Criar componentes DatabaseConsole.tsx para cada tipo de banco
- [ ] Implementar WebSocket gateway para terminal interativo com Docker exec
- [ ] Melhorar WebTerminal.tsx com histórico, autocompletar e comandos reais
- [ ] Adicionar suporte oficial a Heroku Buildpacks além de Nixpacks/Paketo
- [ ] Implementar todos os 120+ templates do EasyPanel (fase contínua)