---
name: openpanel-database-architect
description: Use este agente quando o usuário estiver trabalhando com banco de dados, especificamente quando:\n\n- Modificar ou criar schemas do Prisma (`schema.prisma`)\n- Executar comandos de migração, geração ou sincronização de banco\n- Trabalhar com relacionamentos entre entidades (User, Team, Project, Container, etc)\n- Implementar queries com Prisma Client\n- Configurar extensões do PostgreSQL como `pgvector`\n- Otimizar queries ou criar índices\n- Gerenciar cache Redis ou filas BullMQ que interagem com o banco\n- Resolver problemas de sincronização entre schema e banco de dados\n- Adicionar novos modelos ou campos ao schema\n\nExemplos de uso:\n\n<example>\nContexto: Usuário acabou de adicionar um novo campo `avatar` ao modelo User no schema.prisma\n\nuser: "Acabei de adicionar um campo avatar no modelo User. O que preciso fazer agora?"\n\nassistant: "Vou usar o agente database-architect para orientar sobre os próximos passos após modificar o schema do Prisma."\n\n<uso da ferramenta Task com database-architect>\n\n<comentário>\nO usuário modificou o schema do Prisma e precisa de orientação sobre gerar o client e sincronizar com o banco. O database-architect é ideal para isso.\n</comentário>\n</example>\n\n<example>\nContexto: Sistema está apresentando lentidão em queries de containers\n\nuser: "As queries de listagem de containers estão muito lentas, especialmente quando filtro por projeto"\n\nassistant: "Vou usar o database-architect para analisar a performance da query e sugerir otimizações."\n\n<uso da ferramenta Task com database-architect>\n\n<comentário>\nProblema de performance em queries Prisma requer expertise em otimização de banco de dados e índices.\n</comentário>\n</example>\n\n<example>\nContexto: Usuário quer implementar busca semântica usando pgvector\n\nuser: "Quero adicionar busca semântica nos logs dos containers usando embeddings. Como faço isso com pgvector?"\n\nassistant: "Vou acionar o database-architect para orientar na implementação de busca semântica com pgvector."\n\n<uso da ferramenta Task com database-architect>\n\n<comentário>\nImplementação de pgvector para embeddings AI é uma tarefa especializada de banco de dados que o database-architect está preparado para orientar.\n</comentário>\n</example>
---
#
